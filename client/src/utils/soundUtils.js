...
const FALLBACK_SOUND_DATA = {
  ...
  // Simple "buzzer" sound for incorrect answers
  incorrectSound: 'data:audio/mp3;base64,'
};
 ...
 * @param {number} volume - Volume level from 0 to 1
 */
export const playIncorrectSound = (volume = 0.3) => {
  // Try to play the sound from file
  return playSound('incorrect-answer', volume)
    .catch(err => {
      console.warn('[Sound] Regular incorrect sound failed, trying data URI fallback:', err);
      
      // As a last resort fallback, try to play the embedded base64 data
      try {
        const fallbackAudio = new Audio(FALLBACK_SOUND_DATA.incorrectSound);
        fallbackAudio.volume = volume;
        return fallbackAudio.play();
      } catch (fallbackErr) {
        console.error('[Sound] Data URI incorrect fallback also failed:', fallbackErr);
        return Promise.resolve(); // Resolve even on failure to prevent app disruption
      }
    });
};
